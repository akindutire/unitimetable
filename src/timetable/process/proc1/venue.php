...
include_once("includes.php");
	...
	if(!empty($data->venue) && !empty($data->capacity)){

		$sanitize = new Sanitize;
		$array = $sanitize->cleanData([$data->venue,$data->capacity,$data->location]);
		...
		if ($feedback == true)
			...
			echo json_encode(["msg"=>"Couldn't add Venue, retry","success"=>0]);
