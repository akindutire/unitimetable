	...
	<section class="w3-col l10 m9 s12">
		...
		<div class="w3-col l12 m12 s12 w3-padding" style="display: flex; justify-content: center;">
            ...
            <?php
                ...
                if(count($randomCourse) == 0)
                    goto nodata;


                    echo "<p class='w3-large w3-col l12 m12 s12'>Courses</p>";
                    ...
                    echo "<table class='w3-table w3-col l12 m12 s12 w3-small'>
                        ...
                        foreach ($randomCourse as $code => $course_details) {


                                        echo "<tr class='w3-border-bottom'>
                                                    <td><a class='w3-tag w3-white' data-sig=1 data-c-code='{$code}' ng-click=open_course_setting(\$event)><i class='fas fa-cog'></i></a></td> 
