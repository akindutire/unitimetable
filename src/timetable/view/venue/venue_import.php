		...
		<div class="w3-col l12 m12 s12 w3-padding-large" style="display: flex; justify-content: center; align-items: center; height: 400px;">
			...
			<div class="w3-col l4 m6 s12">
				...
				<p class="w3-col l12 m12 s12">
	                <a href="<?php echo $absPathForLinks.'database/venueformatdoc.csv'; ?>" download>Download venue list format</a>
	             </p>

				<p class="w3-col l12 m12 s12 w3-large "> Import Venue List (csv file required)</p>

	           	<form class="w3-col l12 m12 s12" style="margin-top: 1%;" action="<?php echo "{$absPathForLinks}settings/import/venue"; ?>" method="post" enctype="multipart/form-data">

	                    
	                    <input type="file" placeholder="Import Venue List" name="file" id="" class="w3-input w3-border w3-round"><br>
